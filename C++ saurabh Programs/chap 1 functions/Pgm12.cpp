...
/*
The cpp compiler will automatically map the above area() function call statement to the corresponding overloaded area() function definition having 2 formal parameters at compile time. So in function overloading which overloaded function to call is decided by cpp compiler at compile time itself. based on number and data types of actual parameters passed to function call statement.
